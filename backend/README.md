...
## Project Structure
    ...
    ├── star_citizen_mercha_33822  # Django project configurations
...
1. Clone this repo and `cd star_citizen_mercha_33822`
...
2. Clone this repo and `cd star_citizen_mercha_33822`
